...
public class AttType extends JDialog implements ActionListener
{
  ...
  {   
      ...
      jLabel116.setBounds(new Rectangle(40, 235, 95, 15));
      cmbBehav.setBounds(new Rectangle(160, 190, 200, 20));
      ...
      jLabel115.setBounds(new Rectangle(40, 195, 115, 15));
      cmbMandatory.setBounds(new Rectangle(90, 160, 45, 20));
      ...
      jLabel114.setBounds(new Rectangle(10, 160, 65, 15));
      ...
      txtDefault.setBounds(new Rectangle(95, 305, 145, 20));
      ...
      jLabel17.setBounds(new Rectangle(10, 305, 75, 20));
      jLabel17.setText("Default value:");
      chQueAllowed.setText("jCheckBox1");
      chQueAllowed.setBounds(new Rectangle(135, 233, 20, 20));
      ...
      chNullAllowed.setBounds(new Rectangle(135, 263, 20, 20));
      ...
      chInsAllowed.setBounds(new Rectangle(310, 233, 20, 20));
      ...
      chUpdAllowed.setBounds(new Rectangle(310, 263, 20, 20));
  ...
  private void save()
  {
    ...
    { 
      ...
      if(ID==-1)
      {
       ...
       "'"+ nul +"',"+ cmbBehav.getSelectedIndex()+",'"+ txtDefault.getText() +"',"+ f +")");
      ID=a;
      ...
      "W_default='"+ txtDefault.getText() +"',Fun_id="+ f +"  where  PR_id="+ form.tree.ID +" and  TOB_id="+ TOB +" and Tf_id="+ form.id +" and Att_id="+ID);
