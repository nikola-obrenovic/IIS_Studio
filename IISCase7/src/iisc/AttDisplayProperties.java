...
public class AttDisplayProperties extends ControlPanel 
{
  IISFrameMain parent;
  ...
  public Attribute parFrm;
  private int nextVal;
  private boolean domExists;
  private boolean disabled = false;
  
  public AttDisplayProperties(int p_Width, int p_Height, Connection p_Conn, IISFrameMain p_Parent, int _Att_id, Attribute _attFrm, int _PR_id)
  {
      super();
      conn = p_Conn;
      parent = p_Parent;
      ...
      parFrm = _attFrm;
      PR_id = _PR_id;
      pf = new PropertyFactory(conn, Att_id, this, "A");
  ...
  public void Inherit()
  {
      try
      {
          ...
          ResultSet rs = statement.executeQuery("select Dom_id from IISC_ATTRIBUTE where Att_id=" + Att_id);
          ...
          if (rs.next())
          {
              ...
              ResultSet rs5 = statement5.executeQuery("select * from IISC_ATTRIBUTE_DISPLAY where Att_id=" + Att_id);
              
              if (!rs5.next())
              {
                  statement5.execute("insert into IISC_ATTRIBUTE_DISPLAY(Att_id,PR_id,AD_Type,AD_height,AD_width,AD_text_multiline,AD_text_scroll,AD_radio_orientation,AD_combo_editable, AD_input_align) values(" + Att_id + "," + PR_id + ",0,0,0,0,0,0,0,0)");
              }
              
              statement5.close();
              //
              Statement statement3 = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);   
              ResultSet rs1 = statement3.executeQuery("select * from IISC_DOMAIN_DISPLAY where Dom_id=" + Dom_id);
          
              if (rs1.next())
              {
                  statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_type=" + rs1.getInt("DD_type") + ",AD_width=" + rs1.getInt("DD_width") + ",AD_height=" + rs1.getInt("DD_height") + ",AD_text_multiline=" + rs1.getInt("DD_text_multiline") + ",AD_text_scroll=" + rs1.getInt("DD_text_scroll") +  ",AD_radio_orientation=" + rs1.getInt("DD_radio_orientation") + ",AD_combo_editable=" + rs1.getInt("DD_combo_editable") + ",AD_input_align=" + rs1.getInt("DD_input_align") + " where Att_id=" + Att_id);
                  statement.execute("delete from IISC_ATT_DISPLAY_VALUES where Att_id="+Att_id);
                  ...
                  try
                  {
                      ...
                      ResultSet rs2 = statement4.executeQuery("select max(ADV_id) from IISC_ATT_DISPLAY_VALUES");
                      if (rs2.next())
                      {
                          max = rs2.getInt(1);
                      }
                  ...
                  ResultSet rs4 = statement2.executeQuery("select * from IISC_DOM_DISPLAY_VALUES where Dom_id=" + Dom_id);
              
                  while(rs4.next())
                  {   
                      //String query = "insert into IISC_ATT_DISPLAY_VALUES(ADV_id,PR_id,Att_id,ADV_seq,ADV_value,ADV_value_display) values(" + max + "," + PR_id + "," + Att_id + "," + rs2.getInt("DDV_seq") + ",'" + rs2.getString("DDV_value") + "','" + rs2.getString("DDV_value_display") + "')";
                      //System.out.println(query + "\n");
                      max = max + 1;
                      statement.execute("insert into IISC_ATT_DISPLAY_VALUES(ADV_id,PR_id,Att_id,ADV_seq,ADV_value,ADV_value_display) values(" + max + "," + PR_id + "," + Att_id + "," + rs4.getInt("DDV_seq") + ",'" + rs4.getString("DDV_value") + "','" + rs4.getString("DDV_value_display") + "')");
                  }
 ...
 */
  ...
  private void InitTable()
  {
      ...
      {
          Statement statement = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
          ResultSet rs = statement.executeQuery("select ADV_id, ADV_seq, ADV_value, ADV_value_display from IISC_ATT_DISPLAY_VALUES where Att_id =" + Att_id + " order by ADV_seq");
          
          while(rs.next())
          {
              data.add(new DisplayAttValue(rs.getInt("ADV_id"), rs.getString("ADV_value"), rs.getString("ADV_value_display")));
          }    
          rs.close();
  ...
  public boolean Update()
  {
      ...
      try
      {
        ...
        if (domExists)
        {
            ...
            {
                statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_type=" + mSelectedIndex + " where Att_id=" + Att_id);
            }
            ...
            switch(mSelectedIndex)
            {
                case 0:
                  ...
                  statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_width=" + w + ",AD_height=" + h + ",AD_text_multiline=" + ((JComboBox)textBoxProperties[2].getComponent()).getSelectedIndex() + ",AD_text_scroll=" + ((JComboBox)textBoxProperties[3].getComponent()).getSelectedIndex() + ",AD_input_align=" + ((JComboBox)textBoxProperties[4].getComponent()).getSelectedIndex() + " where Att_id=" + Att_id);
                  break;
                ...
                case 1:
                  ...
                  statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_width=" + w + ",AD_height=" + h + ", AD_radio_orientation=" + ((JComboBox)radioProperties[2].getComponent()).getSelectedIndex() + ",AD_input_align=" + ((JComboBox)radioProperties[3].getComponent()).getSelectedIndex() + " where Att_id=" + Att_id);
                  break;
              ...
              case 3:
                  ...
                  statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_width=" + w + ",AD_height=" + h + ", AD_combo_editable=" + ((JComboBox)comboProperties[2].getComponent()).getSelectedIndex() + ",AD_input_align=" + ((JComboBox)comboProperties[3].getComponent()).getSelectedIndex() + " where Att_id=" + Att_id);
                  break;
              ...
              //case 5:
                  ...
                  statement.execute("update IISC_ATTRIBUTE_DISPLAY set AD_width=" + w + ",AD_height=" + h + ",AD_input_align=" + ((JComboBox)whProperties[2].getComponent()).getSelectedIndex() + " where Att_id=" + Att_id);
                  break;
            }
            ...
            for(i = 0; i < size; i++)
            {
                ...
                if (value.id > -1)
                {
                    statement.execute("delete from IISC_ATT_DISPLAY_VALUES where ADV_id=" + value.id);     
                }
            }
            ...
            for(i = 0; i < size; i++)
            {
                ...
                if (value.id > -1)
                {
                    ...
                    {
                        sql = "update IISC_ATT_DISPLAY_VALUES set ADV_seq=" + i + ",ADV_value=" + value.value + ", ADV_value_display=" + value.displayValue + " where ADV_id=" + value.id;
                        
                        statement.execute("update IISC_ATT_DISPLAY_VALUES set ADV_seq=" + i + ",ADV_value='" + value.value + "', ADV_value_display='" + value.displayValue + "' where ADV_id=" + value.id);    
                  ...
                  if (nextVal == -1)
                    {
                        try
                        {
                            rs2 = statement.executeQuery("select max(ADV_id) from IISC_ATT_DISPLAY_VALUES");
                            if (rs2.next())
                            {
                    ...
                    statement.execute("insert into IISC_ATT_DISPLAY_VALUES(ADV_id, PR_id, Att_id, ADV_seq, ADV_value,ADV_value_display) values(" + (nextVal + 1) + "," + PR_id + "," + Att_id + "," + i + ",'" + value.value + "','" + value.displayValue + "')");
                    value.id = nextVal + 1;
                    value.operation = DisplayAttValue.CLEAN;
                    datm.data.setElementAt(value, i);
                }
      ...
      try
      {
          ...
          switch(mSelectedIndex)
          {
              case 0:
                  ...
                  statement.execute("insert into IISC_ATTRIBUTE_DISPLAY(Att_id,PR_id,AD_Type, AD_height, AD_width, AD_text_multiline,AD_text_scroll,AD_radio_orientation, AD_combo_editable, AD_input_align) values(" + Att_id + "," + PR_id + ", " + mSelectedIndex + "," + h + "," + w + "," + ((JComboBox)textBoxProperties[2].getComponent()).getSelectedIndex() + "," + ((JComboBox)textBoxProperties[3].getComponent()).getSelectedIndex() + ",0,0," + ((JComboBox)textBoxProperties[4].getComponent()).getSelectedIndex() + ")");
                  break;
              ...
              case 1:
                  ...
                  statement.execute("insert into IISC_ATTRIBUTE_DISPLAY(Att_id,PR_id,AD_Type,AD_height,AD_width,AD_text_multiline,AD_text_scroll,AD_radio_orientation,AD_combo_editable, AD_input_align) values(" + Att_id + "," + PR_id + ", " + mSelectedIndex + "," + h + "," + w + ",0,0," + ((JComboBox)radioProperties[2].getComponent()).getSelectedIndex() + ",0," + ((JComboBox)radioProperties[3].getComponent()).getSelectedIndex() + ")");
              ...
              case 3:
                  ...
                  statement.execute("insert into IISC_ATTRIBUTE_DISPLAY(Att_id,PR_id,AD_Type, AD_height, AD_width, AD_text_multiline,AD_text_scroll,AD_radio_orientation,AD_combo_editable, AD_input_align) values(" + Att_id + "," + PR_id + ", " + mSelectedIndex + "," + h + "," + w + ",0,0,0," + ((JComboBox)comboProperties[2].getComponent()).getSelectedIndex() + "," + ((JComboBox)comboProperties[3].getComponent()).getSelectedIndex() + ")");
                  ...
                  //case 5:
                      ...
                      statement.execute("insert into IISC_ATTRIBUTE_DISPLAY(Att_id,PR_id,AD_Type,AD_height,AD_width,AD_text_multiline,AD_text_scroll,AD_radio_orientation,AD_combo_editable, AD_input_align) values(" + Att_id + "," + PR_id + ", " + mSelectedIndex + "," + h + "," + w + ",0,0,0,0," + ((JComboBox)whProperties[2].getComponent()).getSelectedIndex() + ")");
          ...
          for(int i = 0; i < size; i++)
          {
              value = (DisplayAttValue)datm.data.get(i);
              nextVal = nextVal + 1;
              statement.execute("insert into IISC_ATT_DISPLAY_VALUES(ADV_id, PR_id, Att_id, ADV_seq, ADV_value,ADV_value_display) values(" + nextVal + "," + PR_id + "," + Att_id + "," + i + ",'" + value.value + "','" + value.displayValue + "')");
              value.id = nextVal;
              value.operation = DisplayAttValue.CLEAN;
              datm.data.setElementAt(value, i);
          }
