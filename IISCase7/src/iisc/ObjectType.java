...
//import iisc.callgraph.TobDispProperties;
...
public class ObjectType extends JDialog implements ActionListener
{
  ...
  private void jbInit() throws Exception
  {
    ...
    this.att_event_def = new AttEventDef(jTabbedPane1.getWidth() - 15, 240, -1, ID, form.id,  form.tree.ID, con, (IISFrameMain) getParent(), "2");
    this.tob_but_def = new TobButtonDef(jTabbedPane1.getWidth() - 15, 240, ID, form.id,  form.tree.ID, con, (IISFrameMain) getParent());
      
    jTabbedPane1.addTab("Display", jPanel2);
    jTabbedPane1.addTab("Item groups", jPanel3);
    jTabbedPane1.addTab("Events", att_event_def);
    jTabbedPane1.addTab("Buttons", tob_but_def);
                    ...
                    else 
                    {
                        ...
                        if(!cmbParent.getSelectedItem().toString().trim().equals(""))
                        {
                         ...
                         else
                         {
                          ...
                          tdp.Update();
                          ig.Tob_id = ID;
                          this.att_event_def.Tob_id = ID;
                          this.tob_but_def.Tob_id = ID;
                          ig.Update();
                          //ig.U
                          }
                          else
